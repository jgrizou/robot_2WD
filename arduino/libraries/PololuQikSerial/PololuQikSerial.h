#ifndef PololuQikSerial_h
#define PololuQikSerial_h
...
{
  public:
    PololuQik(Stream &ccomms, unsigned char resetPin);
...
{
  public:
    PololuQik2s9v1(Stream &ccomms, unsigned char resetPin) : PololuQik(ccomms, resetPin) {}
...
{
  public:
    PololuQik2s12v10(Stream &ccomms, unsigned char resetPin) : PololuQik(ccomms, resetPin) {}
